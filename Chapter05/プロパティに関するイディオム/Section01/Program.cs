...
namespace Section01 {
    internal class Program {
        static void Main(string[] args) {
            //var obj = new PasswardPolicy("qawsedrftgyhujikolp", "2147483647");
            //var data = obj.Name;
    ...
    class PasswardPolicy {
        ...
        //  setアクセサリーのみを定義した読み取り専用プロパティ
        //public string Name {
        //    get { return FamilyName + "" + GivenName; }
        //}

        public string Name => FamilyName + "" + GivenName;  //ラムダ演算子を使った省略方法

        public PasswardPolicy(string familyName, string givenName) {
